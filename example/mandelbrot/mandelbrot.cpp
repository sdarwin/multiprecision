...
#define BOOST_MULTIPRECISION_MANDELBROT_20_ZOOM_VERY_DEEP_01    20
#define BOOST_MULTIPRECISION_MANDELBROT_21_ZOOM_VERY_DEEP_02    21
#define BOOST_MULTIPRECISION_MANDELBROT_22_ZOOM_VERY_DEEP_03    22
...
int main()
{
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_10_ZOOM_WIKI_01)
    ...
    static_assert(std::numeric_limits<mandelbrot_numeric_type>::digits10 >= 55,
                  "Error: Please use 55 or more decimal digits for BOOST_MULTIPRECISION_MANDELBROT_10_ZOOM_WIKI_01.");

  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_11_ZOOM_WIKI_02)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_11_ZOOM_WIKI_02") + ".jpg";
    ...
    static_assert(std::numeric_limits<mandelbrot_numeric_type>::digits10 >= 55,
                  "Error: Please use 55 or more decimal digits for BOOST_MULTIPRECISION_MANDELBROT_11_ZOOM_WIKI_02.");

  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_12_ZOOM_WIKI_03)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_12_ZOOM_WIKI_03") + ".jpg";
    ...
    static_assert(std::numeric_limits<mandelbrot_numeric_type>::digits10 >= 55,
                  "Error: Please use 55 or more decimal digits for BOOST_MULTIPRECISION_MANDELBROT_12_ZOOM_WIKI_03.");

  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_20_ZOOM_VERY_DEEP_01)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_20_ZOOM_VERY_DEEP_01") + ".jpg";
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_21_ZOOM_VERY_DEEP_02)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_21_ZOOM_VERY_DEEP_02") + ".jpg";
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_22_ZOOM_VERY_DEEP_03)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_22_ZOOM_VERY_DEEP_03") + ".jpg";
