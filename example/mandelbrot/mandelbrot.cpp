...
#define BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_11_ZOOM_VERY_DEEP_01    11
#define BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_12_ZOOM_VERY_DEEP_02    12
#define BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_13_ZOOM_VERY_DEEP_03    13
...
int main()
{
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_11_ZOOM_VERY_DEEP_01)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_11_ZOOM_VERY_DEEP_01") + ".jpg";
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_12_ZOOM_VERY_DEEP_02)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_12_ZOOM_VERY_DEEP_02") + ".jpg";
  ...
  #elif (BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX ==  BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_13_ZOOM_VERY_DEEP_03)

    const std::string str_filename = "images/mandelbrot_" + std::string("BOOST_MULTIPRECISION_MANDELBROT_IMAGE_INDEX_13_ZOOM_VERY_DEEP_03") + ".jpg";
